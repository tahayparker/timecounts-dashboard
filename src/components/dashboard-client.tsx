        ...
        <div>
          {visibleEntries.length === 0 ? (
            ...
            visibleEntries.map((entry, i) => {
              ...
              const isPulseShift = entry.shift_name
                .toLowerCase()
                .startsWith("pulse ");
              // If it is, slice off the first 6 characters ("Pulse ") to leave just the location
              const displayName = isPulseShift
                ? entry.shift_name.substring(6)
                : entry.shift_name;
        ...
        {showExpandControls ? (
          <div className="mt-4 flex items-center justify-between gap-3">
            ...
            >
              ...
              <span>{shown >= totalFiltered ? "Collapse" : "Expand"}</span>
            </button>
          </div>
        ) : null}
      </section>
